...
import com.sun.parent.common.exception.base.IRespCode;
...
/**
 * @Author:ChenLei
 * @Description: com.sun.parent.common.enums.CommonErrorCode.java
 * @Date 11:49 2018/8/6
...
public enum CommonErrorCode implements IErrorCode {
    ...
    public static final List<String> RESULT_DETAIL_MSG_CODE_LIST = Arrays.asList(new String[] {
            "010001", "010002"});
